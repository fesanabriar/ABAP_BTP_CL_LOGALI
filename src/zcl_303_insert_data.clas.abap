class zcl_303_insert_data definition
  public
  final
  create public .
...
class zcl_303_insert_data implementation.

  method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_l_acc_categ,
          lt_catego    type table of ztb_l_categ,
          lt_clientes  type table of ztb_l_clientes,
          lt_clnts_lib type table of ztb_l_clnts_lib,
          lt_libros    type table of ztb_l_libros.
...
******** ztb_l_acc_categ ********
    ...
    delete from ztb_l_acc_categ.
    insert ztb_l_acc_categ from table @lt_acc_categ.
...
******** ztb_l_categ ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_l_categ.
    insert ztb_l_categ from table @lt_catego.
...
******** ztb_l_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_l_clientes.
    insert ztb_l_clientes from table @lt_clientes.
...
******** ztb_l_clnts_lib
    ...
    "Delete possible entries; insert new entries
    delete from ztb_l_clnts_lib.
    insert ztb_l_clnts_lib from table @lt_clnts_lib.
...
******** ztb_l_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_l_libros.
    insert ztb_l_libros from table @lt_libros.
